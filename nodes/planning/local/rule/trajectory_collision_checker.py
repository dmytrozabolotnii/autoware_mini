...
from autoware_mini.geometry import get_angle_between_two_headings, get_vector_norm_2d
            ...
            for obj in detected_objects:
                for path in obj.candidate_trajectories.paths:
                    ...
                    if local_path_buffer.intersects(trajectory_to_check):
                        ...
                        obj_velocity = get_vector_norm_2d(obj.velocity)
                        obj_acceleration = get_vector_norm_2d(obj.acceleration)
