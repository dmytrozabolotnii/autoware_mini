...
| Name | Type | Description |
| ----- | ----- | ------------ |
| `traffic_light_status` | `autoware_mini/TrafficLightResultArray` | Array of detected traffic light states. |
...
ROS node that merges traffic light results from two cameras using majority voting strategy. For each stopline, it counts the detection results from both cameras and selects the most frequent one.
...
| Name | Type | Description |
| ----- | ----- | ------------ |
| `camera1/traffic_light_status` | `autoware_mini/TrafficLightResultArray` | Traffic light results from the first camera. |
| `camera2/traffic_light_status` | `autoware_mini/TrafficLightResultArray` | Traffic light results from the second camera. |
...
| Name | Type | Description |
| ----- | ----- | ------------ |
| `traffic_light_status` | `autoware_mini/TrafficLightResultArray` | Merged traffic light results. |
...
| Name | Type | Description |
| ----- | ----- | ------------ |
| `tfl_status_topic_1` | `autoware_mini/TrafficLightResultArray` | Traffic light results from the first (priority) source. |
| `tfl_status_topic_2` | `autoware_mini/TrafficLightResultArray` | Traffic light results from the second source. |
...
| Name | Type | Description |
| ----- | ----- | ------------ |
| `traffic_light_status` | `autoware_mini/TrafficLightResultArray` | Merged traffic light results based on priority rules. |
