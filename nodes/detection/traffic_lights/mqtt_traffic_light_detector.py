...
from autoware_mini.lanelet2 import load_lanelet2_map, get_stop_lines_api_id_in_area
...
class MqttTrafficLightDetector:
    def __init__(self):
        ...
        if self.enable_automatic_subscribe:
            ...
            self.stop_line_ids = get_stop_lines_api_id_in_area(self.lanelet2_map)
    ...
    def current_pose_callback(self, msg):
        ...
        stop_line_ids_in_range = get_stop_lines_api_id_in_area(self.lanelet2_map, msg.pose.position.x, msg.pose.position.y, 
